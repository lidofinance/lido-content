    ...
    q&a:
      ...
      - question: How can I get stETH?
        answer: You can get stETH many ways, including interacting with the smart
          ...
          staking widget](https://{{ethereum_staking_host}}/) or in other [DEX Lido
          integrations](https://{{landing_host}}/lido-ecosystem?tokens=stETH&categories=Get).
      - question: How can I use stETH?
        answer: You can use your stETH as collateral, for lending,
          and [more](https://{{landing_host}}/lido-ecosystem?tokens=stETH&categories=Earn).
      - question: How can I unstake stETH?
        answer: You can use our [Withdrawals Request and Claim
          tabs](https://{{ethereum_staking_host}}/withdrawals) to unstake stETH and receive
      ...
      - question: How can I get wstETH?
        answer: You can wrap your stETH or ETH tokens using [Wrap & Unwrap staking
          widget](https://{{ethereum_staking_host}}/wrap) or [DEX Lido
          integrations](https://{{landing_host}}/lido-ecosystem?tokens=wstETH&categories=Get).
      - question: How can I use wstETH?
        answer: wstETH is useful
          across [L2](https://{{landing_host}}/lido-ecosystem?networks=arbitrum%2Coptimism) and
          other [DeFi
          protocols](https://{{landing_host}}/lido-ecosystem?tokens=wstETH&categories=Earn),
      ...
      - question: How can I unwrap wstETH?
        answer: You can unwrap your wstETH tokens using [Wrap & Unwrap staking
          widget](https://{{ethereum_staking_host}}/wrap?mode=unwrap).
      - question: Do I need to unwrap my wstETH before requesting withdrawals?
        answer: No, you can transform your wstETH to ETH using the [Withdrawals Request
          and Claim tabs](https://{{ethereum_staking_host}}/withdrawals). Note that, under
      ...
      - question: What is Lido staking APR for Ethereum?
        answer: >-
          ...
          More about Lido Lido staking APR for Ethereum you could find on the [Ethereum landing page](https://{{landing_host}}/ethereum) and in our [Docs](https://{{ethereum_docs_host}}/).
      - question: What is Lido on L2?
        answer: With Lido protocol, users could bridge wstETH to L2’s like Arbitrum and
          ...
          opportunities](https://{{help_host}}/en/articles/6655781-lido-on-l2-an-overview).
      - question: What is the Insurance fund used for?
        answer: The [Insurance
          ...
          scenarios [here](https://{{research_forum_host}}/t/redirecting-incoming-revenue-stream-from-insurance-fund-to-dao-treasury/2528/20?u=kadmil).
    ...
    q&a:
      ...
      - question: How can I get stMatic?
        answer: stMATIC is available in many ways, including directly staking MATIC
          ...
          widget](https://{{polygon_stake_host}}/) or through other [DEX Lido
          integrations](https://{{landing_host}}/lido-ecosystem?categories=Get&tokens=stMATIC).
      - question: How can I use stMATIC?
        answer: With stMATIC users can grow MATIC, get instant liquidity, or participate
          ...
          can be
          found [here](https://{{landing_host}}/lido-ecosystem?tokens=stMATIC&categories=Earn).
      - question: How can I unstake stMATIC?
        answer: stMATIC can be unstaked in several ways, including through [the Lido on
          Polygon unstake widget](https://{{polygon_stake_host}}/). The default stMATIC
          unstaking period takes around 3-4 days to process. After that, users
          can claim rewards in the [Claim tab](https://{{polygon_stake_host}}/).
          ...
          exchanges [here](https://{{landing_host}}/lido-ecosystem?tokens=stMATIC&categories=Get).
    ...
    q&a:
      ...
      - question: How does the Lido governance process work?
        answer: >-
          ...
          [Learn more](https://{{landing_host}}/governance)
    ...
    q&a:
      - question: Who are Node Operators used with Lido protocols?
        answer: >-
          ...
          [Learn more](https://{{operatorportal_host}}/)
      - question: How to apply to be a Node Operator for Lido?
        answer: You could explore the requirements to be considered and apply to be a
          ...
          Portal](https://{{operatorportal_host}}/apply-to-be-a-lido-node-operator).
  - name: Security
    q&a:
      ...
      - question: Does Lido DAO have a Bug Bounty program?
        answer: Lido DAO uses the [Immunefi platform](https://immunefi.com/) — the
          ...
          is [here](https://{{landing_host}}/bug-bounty).
  - name: Additional
    q&a:
      - question: Where can I find more info for developers?
        answer: >-
          * [Lido on
          Ethereum](https://{{ethereum_docs_host}}/guides/steth-integration-guide)

          * [Lido on Polygon](https://{{polygon_docs_host}}/)
      - question: Where can I get info about Lido integrations?
        answer: All info about Lido integrations you can find in our [Help
          Center](https://{{help_host}}/en/) or on the [Lido Ecosystem
          page](https://{{landing_host}}/lido-ecosystem).
      - question: Where can I go to join Lido DAO’s community?
        answer: >-
          ...
          * Learn about Lido on [Blog](https://{{blog_host}}/).

          * Contribute to the codebase in [GitHub](https://github.com/lidofinance).

          * Stay updated through the [Research forum](https://{{research_forum_host}}/).
      - question: How can I become a partner with Lido DAO?
        answer: Any blockchain developer, crypto enthusiast, or member of the community
          ...
          goals, [here is the info](https://{{landing_host}}/lego) for you.
---
