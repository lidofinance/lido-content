...
content: >-
  ...
  #### Delegation
    ...
    Delegated votes are counted alongside direct votes and can be tracked on the voting platform. The tokenholder can override the delegate’s decision or revoke delegation rights at any time. [Learn more]({{vote_url}}/vote/delegation).
  ...
  #### Easy Tracks (Optimistic Governance)
    ...
    [The Easy Track]({{vote_url}}/easy-track) is an optimistic governance tool for routine DAO operations used to reduce voter fatigue.
  ...
  #### How to Engage
    ...
    **Vote or Delegate:** LDO holders vote on proposals via Snapshot (off-chain) and Aragon (on-chain). Voting power [can be delegated]({{vote_url}}/vote/delegation) to trusted representatives while retaining full control; delegation can be overridden or revoked at any time.
