...
content: >-
  ...
  wstETH can be bridged to several Layer 2 (L2) and Layer 1 (L1) networks, including OP Mainnet, Base, Arbitrum, Linea, BNB Chain, and Unichain. For information about recent changes to the list of supported networks, see [Lido Multichain: Network Support Changes (June 2026)]({{blog_url}}/lido-multichain-update-june-2026/).
