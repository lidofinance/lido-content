    ...
    q&a:
      ...
      - question: What are the main risks of using the Community Staking Module?
        answer: |-
          ...
          * **Code Risks:** The CSM code could contain smart contract or off-chain software vulnerabilities or bugs. To help minimize these risks, the [code](https://github.com/lidofinance/staking-modules) is open-sourced, covered by multiple third-party [audits](https://github.com/lidofinance/audits), and supported by a robust [Immunefi](https://immunefi.com/bug-bounty/lido/information/) bug-bounty program. In addition, upgrades occur via on-chain governance.
