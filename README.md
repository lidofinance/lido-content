...
```
"{{landing_url}}" = "https://testnet.fi"
"{{landing}}" = "testnet.fi"
"{{ethereum_stake_url}}" = "https://stake.testnet.fi"
"{{ethereum_stake}}" = "stake.testnet.fi"
"{{ethereum_docs_url}}" = "https://docs.lido.fi"
"{{ethereum_docs}}" = "docs.lido.fi"
"{{polygon_stake_url}}" = "https://polygon.testnet.fi"
"{{polygon_stake}}" = "polygon.testnet.fi"
...
"{{vote_url}}" = "https://vote.testnet.fi"
"{{vote}}" = "vote.testnet.fi"
"{{easytrack_url}}" = "https://easytrack.testnet.fi"
"{{easytrack}}" = "easytrack.testnet.fi"
